...
const getters = {
    data: state => state.data,
        ...
        siteTitle: state => state.data.siteTitle,
        siteTagline: state => state.data.siteTagline,
        siteLogo: state => state.data.siteLogo,
        siteLogoAlt: state => state.data.siteLogoAlt,
        siteFavicon: state => state.data.siteFavicon,
        navLogo: state => state.data.navLogo,
        navMenu: state => state.data.navMenu,
        navMenuNew: state => state.data.navMenuNew,
    ...
    styles: state => state.styles,
        ...
        siteLogoSize: state => state.styles.siteLogoSize,
