        ...
        <div class="d-inline-flex">
          ...
          <a-popover trigger="click" placement="topRight">
            <template slot="content">
              <p class="pt-2">
                The Customizer allows you to change
                <br />the look and feel of your store and to <br />preview
        ...
        <a-collapse accordion>
          <a-collapse-panel header="Fonts" key="1" :showArrow="false">
            <div class="settings__item">
              ...
              <a-select
                ...
                @change="setPriFont"
              >
                <a-select-option value="fontPriLato" class="fontPriLato"
                  >Lato</a-select-option
                >
                <a-select-option value="fontPriPlayfair" class="fontPriPlayfair"
                  >Playfair Display</a-select-option
                >
                <a-select-option value="fontPriRoboto" class="fontPriRoboto"
                  >Roboto</a-select-option
                >
                <a-select-option value="fontPriOpensans" class="fontPriOpensans"
                  >Open Sans</a-select-option
                >
                <a-select-option value="fontPriPoppins" class="fontPriPoppins"
                  >Poppins</a-select-option
                >
                <a-select-option value="fontPriAbril" class="fontPriAbril"
                  >Abril Fatface</a-select-option
                >
                <a-select-option
                  value="fontPriCalistoga"
                  class="fontPriCalistoga"
                  >Calistoga</a-select-option
                >
                <a-select-option
                  value="fontPriMontserrat"
                  class="fontPriMontserrat"
                  >Montserrat</a-select-option
                >
                <a-select-option
                ...
                >
                <a-select-option value="fontPriNunito" class="fontPriNunito"
                  >Nunito</a-select-option
                >
              </a-select>
            </div>
            <div class="settings__item">
              ...
              <a-select
                ...
                @change="setSecFont"
              >
                <a-select-option value="fontSecLato" class="fontPriLato"
                  >Lato</a-select-option
                >
                <a-select-option value="fontSecPlayfair" class="fontPriPlayfair"
                  >Playfair Display</a-select-option
                >
                <a-select-option value="fontSecRoboto" class="fontPriRoboto"
                  >Roboto</a-select-option
                >
                <a-select-option value="fontSecOpensans" class="fontPriOpensans"
                  >Open Sans</a-select-option
                >
                <a-select-option value="fontSecPoppins" class="fontPriPoppins"
                  >Poppins</a-select-option
                >
                <a-select-option value="fontSecAbril" class="fontPriAbril"
                  >Abril Fatface</a-select-option
                >
                <a-select-option
                  value="fontSecCalistoga"
                  class="fontPriCalistoga"
                  >Calistoga</a-select-option
                >
                <a-select-option
                  value="fontSecMontserrat"
                  class="fontPriMontserrat"
                  >Montserrat</a-select-option
                >
                <a-select-option
                  ...
                  >Cormorant Garamond</a-select-option
                >
                <a-select-option value="fontSecNunito" class="fontPriNunito"
                  >Nunito</a-select-option
                >
              </a-select>
            </div>
          ...
          <a-collapse-panel header="Colors" key="2" :showArrow="false">
            <div class="settings__item">
              ...
              <a-button
                type="primary"
                @click="showPriColorCP = !showPriColorCP"
                v-bind:style="{
            ...
            <div class="settings__item">
              ...
              <a-button
                type="primary"
                @click="showSecColorCP = !showSecColorCP"
                v-bind:style="{
          ...
          <a-collapse-panel header="Menu" key="3" :showArrow="false">
            <div class="settings__item">
              ...
              <h3>Menu Layout</h3>
              <a-radio-group
                @change="setNavLayout($event.target.value)"
                :defaultValue="navLayout"
              >
            ...
            <div class="settings__modal">
              <a-button type="primary" @click="menuSettings"
                >More Settings</a-button
              >
              <a-modal
                title="Modify Menu Content"
                  ...
                  >
                    ...
                    <div class="settings__modal-item">
                      ...
                      <a-button
                        type="primary"
                        size="small"
                        @click="showNavLogoTextCP = !showNavLogoTextCP"
                        >Select Color</a-button
                      >
                      <swatches-picker
                        v-if="showNavLogoTextCP"
                        :value="navLogoTextColor"
                        @input="setNavLogoTextColor($event.hex)"
                        :disableAlpha="true"
                      />
                    </div>
                    <div class="settings__modal-item">
                      <p>Text Logo Size</p>
                      <a-slider
                        @change="setNavLogoTextSize"
                        :min="10"
                        :max="50"
                        :defaultValue="navLogoTextSize"
                      />
                    </div>
                  </a-collapse-panel>
                  <a-collapse-panel
                  ...
                  >
                    <div class="settings__modal-item">
                      ...
                      <a-select
                        ...
                        @change="setNavType"
                      >
                        <a-select-option value="navFixed"
                          >Fixed Menu</a-select-option
                        >
                        <a-select-option value="navTrans"
                          >Transparent Menu</a-select-option
                        >
                      </a-select>
                    </div>
                  </a-collapse-panel>
...
=======
                ...
                <div class="settings__modal">
                  <a-button type="primary" @click="heroSettings"
                    >More Settings</a-button
                  >
                  <a-modal
                    ...
                    <a-collapse defaultActiveKey="1" accordion>
                      ...
                      >
                        <div class="settings__modal-item">
                          ...
                          <a-button
                            type="primary"
                            @click="showHeroColorCP = !showHeroColorCP"
                            v-bind:style="{
                        ...
                        <div class="settings__modal-item">
                          ...
                          <div class="settings__switch">
                            <a-switch
                              :defaultChecked="heroBgImgShow"
                              @change="setHeroBgImgShow"
                            />
                          </div>
                          <div class="settings__upload">
...
>>>>>>> 528a7631f96440b47380bbed82f001c572aa59a3
                        </div>
                      </a-collapse-panel>
                      <a-collapse-panel
                        header="Hero Content"
                      ...
                      >
                        ...
                        <div class="settings__modal-item">
                          ...
                          <div class="settings__switch">
                            <a-switch
                              :defaultChecked="heroImageShow"
                              @change="setHeroImageShow"
                            />
                          </div>
                          <div class="settings__upload">
                            <a-button type="primary" @click="uploadWidget()"
                      ...
                      >
                        <div class="settings__modal-item">
                          ...
                          <a-button
                            type="primary"
                            size="small"
                            @click="showHeroBtnPriCP = !showHeroBtnPriCP"
                            v-bind:style="{
                              backgroundColor: heroBtnPri,
                              borderColor: heroBtnPri,
                              color: heroBtnSec
                            }"
                            >Select Color</a-button
                          >
                          <swatches-picker
                            v-if="showHeroBtnPriCP"
                            :value="heroBtnPri"
                        ...
                        <div class="settings__modal-item">
                          ...
                          <a-button
                            type="primary"
                            size="small"
                            @click="showHeroBtnSecCP = !showHeroBtnSecCP"
                            v-bind:style="{
                              backgroundColor: heroBtnPri,
                              borderColor: heroBtnPri,
                              color: heroBtnSec
...
>>>>>>> 528a7631f96440b47380bbed82f001c572aa59a3
            ...
            <a-collapse-panel header="Collection" key="2" :showArrow="false">
              ...
              <div class="settings__modal">
                <a-button type="primary" @click="collectionSettings"
                  >More Settings</a-button
                >
                <a-modal
                  title="Modify Collection Content"
                  v-model="showCollectionSettings"
                  onOk="saveCollectionSettings"
                >
                  <template slot="footer">
                    <a-button key="back" @click="collectionCancel"
                      >Cancel</a-button
                    >
                    <a-button
                      key="submit"
                  ...
                  <a-collapse defaultActiveKey="1" accordion>
                    ...
                    >
                      <div class="settings__modal-item">
                        ...
                        <a-button
                          type="primary"
                          @click="showCollectionBtnCP = !showCollectionBtnCP"
                          v-bind:style="{
                            backgroundColor: collectionBtnColor,
                            borderColor: collectionBtnColor
                          }"
                          >Select Color</a-button
                        >
                        <swatches-picker
                          v-if="showCollectionBtnCP"
                          :value="collectionBtnColor"
                          @input="setCollectionBtnColor($event.hex)"
                          :disableAlpha="true"
                        />
                      </div>
                    </a-collapse-panel>
                    <a-collapse-panel
                      header="Collection One"
                      key="2"
                      :showArrow="false"
                    >
                      <div class="settings__modal-item">
                        ...
                        <div class="settings__switch">
                          <a-switch
                            :defaultChecked="collectionOneShow"
                            @change="setCollectionOneShow"
                            size="small"
                          />
                        </div>
                      </div>
                      <div class="settings__modal-item">
                        ...
                        <a-button
                          type="primary"
                          @click="
                            showCollectionOneBgCP = !showCollectionOneBgCP
                          "
                          v-bind:style="{
                            backgroundColor: collectionOneBg,
                            borderColor: collectionOneBg
                          }"
                          >Select Color</a-button
                        >
                        <swatches-picker
                          v-if="showCollectionOneBgCP"
                          :value="collectionOneBg"
                          @input="setCollectionOneBg($event.hex)"
                          :disableAlpha="true"
                        />
                      </div>
                      <div class="settings__modal-item">
                        <p>Collection Title</p>
                        <a-input
                          @change="setCollectionOneTitle($event.target.value)"
                          :placeholder="collectionOneTitle"
                        />
                      </div>
                      <div class="settings__modal-item">
                        <p>Collection Image</p>
                      ...
                      <div class="settings__modal-item">
                        ...
                        <a-input
                          @change="
                            setCollectionOneSubtitle($event.target.value)
                          "
                          :placeholder="collectionOneSubtitle"
                        />
                      </div>
                      <div class="settings__modal-item">
                        <p>Collection Button</p>
                        <a-input
                          @change="setCollectionOneBtn($event.target.value)"
                          :placeholder="collectionOneBtn"
                        />
                      </div>
                      <div class="settings__modal-item">
                        <p>Collection Button Link</p>
                        <a-input
                          @change="setCollectionOneLink($event.target.value)"
                          :placeholder="collectionOneLink"
                        />
                      </div>
                    </a-collapse-panel>
                    <a-collapse-panel
                      header="Collection Two"
                      key="3"
                      :showArrow="false"
                    >
                      <div class="settings__modal-item">
                        ...
                        <div class="settings__switch">
                          <a-switch
                            :defaultChecked="collectionTwoShow"
                            @change="setCollectionTwoShow"
                            size="small"
                          />
                        </div>
                      </div>
                      <div class="settings__modal-item">
                        ...
                        <a-button
                          type="primary"
                          @click="
                            showCollectionTwoBgCP = !showCollectionTwoBgCP
                          "
                          v-bind:style="{
                            backgroundColor: collectionTwoBg,
                            borderColor: collectionTwoBg
                          }"
                          >Select Color</a-button
                        >
                        <swatches-picker
                          v-if="showCollectionTwoBgCP"
                          :value="collectionTwoBg"
                          @input="setCollectionTwoBg($event.hex)"
                          :disableAlpha="true"
                        />
                      </div>
                      <div class="settings__modal-item">
                        <p>Collection Title</p>
                        <a-input
                          @change="setCollectionTwoTitle($event.target.value)"
                          :placeholder="collectionTwoTitle"
                        />
                      </div>
                      <div class="settings__modal-item">
                        <p>Collection Description</p>
                        <a-input
                          @change="
                            setCollectionTwoSubtitle($event.target.value)
                          "
                          :placeholder="collectionTwoSubtitle"
                        />
                      </div>
                      <div class="settings__modal-item">
                        <p>Collection Image</p>
                      ...
                      <div class="settings__modal-item">
                        <p>Collection Button</p>
                        <a-input
                          @change="setCollectionTwoBtn($event.target.value)"
                          :placeholder="collectionTwoBtn"
                        />
                      </div>
                      <div class="settings__modal-item">
                        <p>Collection Button Link</p>
                        <a-input
                          @change="setCollectionTwoLink($event.target.value)"
                          :placeholder="collectionTwoLink"
                        />
                      </div>
                    </a-collapse-panel>
                    <a-collapse-panel
                      header="Collection Three"
                      key="4"
                      :showArrow="false"
                    >
                      <div class="settings__modal-item">
                        ...
                        <div class="settings__switch">
                          <a-switch
                            :defaultChecked="collectionThreeShow"
                            @change="setCollectionThreeShow"
                            size="small"
                          />
                        </div>
                      </div>
                      <div class="settings__modal-item">
                        ...
                        <a-button
                          type="primary"
                          @click="
                            showCollectionThreeBgCP = !showCollectionThreeBgCP
                          "
                          v-bind:style="{
                            backgroundColor: collectionThreeBg,
                            borderColor: collectionThreeBg
                          }"
                          >Select Color</a-button
                        >
                        <swatches-picker
                          v-if="showCollectionThreeBgCP"
                          :value="collectionThreeBg"
                          @input="setCollectionThreeBg($event.hex)"
                          :disableAlpha="true"
                        />
                      </div>
                      <div class="settings__modal-item">
                        <p>Collection Title</p>
                        <a-input
                          @change="setCollectionThreeTitle($event.target.value)"
                          :placeholder="collectionThreeTitle"
                        />
                      </div>
                      <div class="settings__modal-item">
                        <p>Collection Description</p>
                        <a-input
                          @change="
                            setCollectionThreeSubtitle($event.target.value)
                          "
                          :placeholder="collectionThreeSubtitle"
                        />
                      </div>
                      <div class="settings__modal-item">
                        <p>Collection Image</p>
                      ...
                      <div class="settings__modal-item">
                        <p>Collection Button</p>
                        <a-input
                          @change="setCollectionThreeBtn($event.target.value)"
                          :placeholder="collectionThreeBtn"
                        />
                      </div>
                      <div class="settings__modal-item">
                        <p>Collection Button Link</p>
                        <a-input
                          @change="setCollectionThreeLink($event.target.value)"
                          :placeholder="collectionThreeLink"
                        />
                      </div>
                    </a-collapse-panel>
                  </a-collapse>
            ...
            <a-collapse-panel header="Products" key="3" :showArrow="false">
              <div class="settings__item">
                <div class="settings__switch">
                  <h3>Show</h3>
                  <a-switch
                    :defaultChecked="productShow"
                    @change="setProductShow"
                    size="small"
                  />
                </div>
                <h3>Product Layout</h3>
                <a-radio-group
                  @change="setProductLayout($event.target.value)"
                ...
                <div class="settings__modal">
                  <a-button type="primary" @click="productSettings"
                    >More Settings</a-button
                  >
                  <a-modal
                    title="Modify Product Content"
                    v-model="showProductSettings"
                    onOk="saveProductSettings"
                  >
                    <template slot="footer">
                      <a-button key="back" @click="productCancel"
                        >Cancel</a-button
                      >
                      <a-button
                        key="submit"
                    ...
                    <a-collapse defaultActiveKey="1" accordion>
                      ...
                      >
                        <div class="settings__modal-item">
                          ...
                          <a-button
                            type="primary"
                            @click="showProdBgCP = !showProdBgCP"
                            v-bind:style="{
                              backgroundColor: productBg,
                              borderColor: productBg
                            }"
                            >Select Color</a-button
                          >
                          <swatches-picker
                      ...
                      >
                        <div class="settings__modal-item">
                          ...
                          <a-button
                            type="primary"
                            @click="
                              showProductTitleBgCP = !showProductTitleBgCP
                            "
                            v-bind:style="{
                              backgroundColor: productTitleBgColor,
                              borderColor: productTitleBgColor
                            }"
                            >Select Color</a-button
                          >
                          <swatches-picker
                            v-if="showProductTitleBgCP"
                            :value="productTitleBgColor"
                            @input="setProductTitleBgColor($event.hex)"
                            :disableAlpha="true"
                          />
                        </div>
                        <div class="settings__modal-item">
                          ...
                          <div class="settings__switch">
                            <a-switch
                              :defaultChecked="productTitleShow"
                              @change="setProductTitleShow"
                              size="small"
                            />
                          </div>
                          <div class="pb-3">
                            <a-input
                              @change="setProductTitleMain($event.target.value)"
                              :placeholder="productTitleMain"
                            />
                            <a-button
                              type="primary"
                              size="small"
                              @click="
                                showProdTitleMainCP = !showProdTitleMainCP
                              "
                              v-bind:style="{
                                backgroundColor: productTitleMainColor,
                                borderColor: productTitleMainColor
                              }"
                              >Select Color</a-button
                            >
                            <swatches-picker
                              v-if="showProdTitleMainCP"
                              :value="productTitleMainColor"
                              @input="setProductTitleMainColor($event.hex)"
                              :disableAlpha="true"
                            />
                          </div>
                          <div class="pb-3">
                            <a-input
                              @change="setProductTitleSub($event.target.value)"
                              :placeholder="productTitleSub"
                            />
                            <a-button
                              type="primary"
                              size="small"
                              @click="showProdTitleSubCP = !showProdTitleSubCP"
                              v-bind:style="{
                                backgroundColor: productTitleSubColor,
                                borderColor: productTitleSubColor
                              }"
                              >Select Color</a-button
                            >
                            <swatches-picker
                              v-if="showProdTitleSubCP"
                              :value="productTitleSubColor"
                              @input="setProductTitleSubColor($event.hex)"
                              :disableAlpha="true"
                            />
                          </div>
                        </div>
                        <div class="settings__modal-item">
                          <p>Layout</p>
                          <a-radio-group
                            @change="setProductTitleLayout($event.target.value)"
                            :defaultValue="productTitleLayout"
                          >
            ...
            <a-collapse-panel header="Footer" key="1" :showArrow="false">
              <div class="settings__item">
                <div class="settings__switch">
                  <h3>Show</h3>
                  <a-switch
                    :defaultChecked="footerShow"
                    @change="setFooterShow"
                    size="small"
                  />
                </div>
                <h3>Footer Layout</h3>
      ...
      <div class="settings__dashboard">
        <a-button size="large" block>
          <a-icon type="dashboard" />Return to Dashboard
        </a-button>
      </div>
    </div>
  </div>
...
>>>>>>> 528a7631f96440b47380bbed82f001c572aa59a3
    ...
    openNotificationWithIcon(type) {
      this.$notification[type]({
        message: "Success",
        description: "You have saved your storefront design successfully."
      });
    },
