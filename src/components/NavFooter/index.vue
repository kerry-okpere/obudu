<template>
  <footer>
              ...
              <div class="footer__one-contact">
                <div class="logo">
                  <img
                    ...
                    width="200"
                  />
                  <h1 v-else :style="{ color: navLogoTextColor }">
                    {{ storeName }}
                  </h1>
                </div>
                <p>{{ metadata.phone }}</p>
                ...
                <div class="footer__one-social">
                  <a :href="formatLink(metadata.facebook)" target="_blank">
                    <v-icon name="brands/facebook-f" />
                  </a>
                  <a :href="formatLink(metadata.twitter)" target="_blank">
                    <v-icon name="brands/twitter" />
                  </a>
                  <a :href="formatLink(metadata.instagram)" target="_blank">
    ...
    <section class="subfooter" v-if="subfooterShow">
      ...
      <section
        class="subfooter__one"
        v-if="subfooterLayout === 1"
        :style="{ backgroundColor: priColor, color: navColor }"
      >
        <div class="container">
          <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
              <div class="subfooter__one-copyright">
                <p>
                  ...
                  <a :href="storeUrl" :style="{ color: subfooterColor }">{{
                    storeName
                  }}</a>
                  - All Rights Reserved.
                </p>
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="subfooter__one-payment pt-3">
                    <img
                      src="@/assets/img/footer/paystack.svg"
                      alt="Paystack Logo"
                      width="100"
                    />
      ...
      <section
        class="subfooter__two"
        v-if="subfooterLayout === 2"
        :style="{ backgroundColor: priColor, color: navColor }"
      >
        <div class="container">
          <div class="row">
      ...
      <section
        class="subfooter__three"
        v-if="subfooterLayout === 3"
        :style="{ backgroundColor: priColor, color: navColor }"
      >
        <div class="container">
          <div class="row">
...
export default {
  ...
  async created() {
    ...
    this.metadata = res;
    this.storeUrl = `https://${window.location.host}`;
  }
};
</script>
