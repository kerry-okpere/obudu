                ...
                <div class="row">
                    <div class="col" v-for="(product, index) in products" :key="index" >
                        <a-card :hoverable="false" @mouseover="hover = true" @mouseleave="hover = false" :bordered="true" :loading="loading" style="width: 240px">
                            ...
                            <a-button type="primary" v-bind:style="{backgroundColor: this.$store.state.styles.priColor, borderColor: this.$store.state.styles.priColor}">Buy Now</a-button>
                ...
                <div class="row">
                    <div class="col-6 col-xl-3 col-lg-3 col-md-4 col-sm-6">
                        <a-card :hoverable="false" @mouseover="hover = true" @mouseleave="hover = false" :bordered="true" :loading="loading" style="width: 240px">
                            ...
                            <a-button type="primary" v-bind:style="{backgroundColor: this.$store.state.priColor, borderColor: this.$store.state.priColor}">Buy Now</a-button>
                            <div class="products__one-meta">
                                <h2>Product Name</h2>
