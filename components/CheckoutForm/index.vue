            ...
            <b-form @submit="onSubmit" @reset="onReset" v-if="show">
              ...
              <b-form-group id="first-name" label="First Name *" label-for="first-name">
                <b-form-input id="first-name" v-model="form.firstName" required placeholder="Your first name"></b-form-input>
                    <b-alert v-if="form.error" show variant="danger"><a href="#" class="alert-link">Please select a variant</a></b-alert>
              </b-form-group>
              ...
              <b-form-group id="company-name" label="Company Name *" label-for="company-name">
                <b-form-input id="company-name" v-model="form.companyName" required placeholder="Your Company Name"></b-form-input>
              </b-form-group>
              ...
              <b-form-group id="postal-code" label="Postal Code *" label-for="postal-code">
                <b-form-input id="postal-code" v-model="form.postCode" required placeholder="Your postal code"></b-form-input>
              </b-form-group>
              ...
              <b-form-group id="state" label="State *" label-for="state">
                <b-form-input id="state" v-model="form.state" required placeholder="State"></b-form-input>
              </b-form-group>
              ...
              <b-form-group id="submit-btn" class="pb-50">
