<template>
    <div class="collection-products__section w-container">
            <div class="collection-products__container w-row">
                <div class="collection-products__left w-col w-col-3">
                ...
                <div class="collection-products__right w-col w-col-9">
                    <h1 class="home-section-title">BAGS</h1>
                    <div class="w-layout-grid grid-2 collection-products__grid">
                    ...
                    <h1 class="home-section-title">SUNGLASSES</h1>
                    <div class="w-layout-grid grid-2 collection-products__grid">
                        <div class="home-products__single">
                            <div class="home-products__image">
                                <a href="#" class="button-2 w-button">ADD TO CART</a>
